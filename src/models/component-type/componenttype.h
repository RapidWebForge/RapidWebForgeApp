...
const std::map<ComponentType, std::map<std::string, std::string>> componentPropertiesMap = {
    ...
    {ComponentType::Input,
     {{"class", "border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-gray-400"},
      ...
      {"maxlength", ""},
      {"required", "false"}}},
    {ComponentType::Label, {{"class", "font-semibold text-sm"}, {"text", "Default Label"}, {"for", ""}}},
    {ComponentType::TextArea,
     {{"class", "border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-gray-400"}, {"placeholder", "Enter text"}, {"minlength", ""}, {"maxlength", ""}}},
    {ComponentType::Button,
     {{"class", "bg-blue-600 rounded-lg text-white text-sm font-semibold hover:bg-blue-800 px-4 py-2 cursor-pointer"}, {"text", "Default Button"}, {"type", "button"}, {"click", ""}}},
    {ComponentType::Hyperlink,
     {{"class", ""}, {"text", "Default Hyperlink"}, {"href", ""}, {"target", "_self"}, {"rel", ""}}},
    {ComponentType::Form, {{"class", "flex flex-col items-center"}, {"method", "POST"}, {"model", ""}}},
    {ComponentType::HorizontalLayout, {{"class", ""}}},
    {ComponentType::VerticalLayout, {{"class", ""}}},
    {ComponentType::ModelLayout, {{"class", "flex flex-col items-center"}, {"model", ""}, {"get", "ALL"}}},
